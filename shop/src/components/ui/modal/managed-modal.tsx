...
const CancelOrderModal = dynamic(
  () => import('@/components/orders/cancel-order-popup'),
  { ssr: false }
);
const VariationPopup = dynamic(() => import('@/components/products/cards/variation-popup'));
...
const ManagedModal = () => {
  ...
  return (
    <Modal open={isOpen} onClose={closeModal}>
      ...
      {view === 'CANCEL_ORDER' && <CancelOrderModal />}
      {view === 'VARIATION_POPUP' && <VariationPopup  product={data?.productSlug} />}
