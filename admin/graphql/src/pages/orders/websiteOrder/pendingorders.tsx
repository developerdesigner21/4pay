...
export default function WebsitePendingOrderPage() {
    ...
    const PendingOrderData: any = data?.orderstatus;
        ...
        <>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4 gap-14 py-5'>
                ...
                {isActualizar === true ?
                    (SelectionDateFilter?.map((item: any, index: any) => {
                        ...
                        return (
                            ...
                            <div className='relative' key={index}>
                                <div className='bg-[#FFF50017] p-5 rounded-lg overflow-y-auto grow'>
                    ...
                    (PendingOrderData?.map((item: any, index: any) => {
                        return (
                            <div className='relative' key={index}>
                                <div className='bg-[#FFF50017] p-5 rounded-lg overflow-y-auto grow'>
                                    <div className='flex felx-row justify-between justify-items-center'>
...
WebsitePendingOrderPage.authenticate = {
    permissions: adminOnly,
};
WebsitePendingOrderPage.Layout = Layout;
