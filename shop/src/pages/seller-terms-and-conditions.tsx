...
export default function SellerTermsAndConditionPage() {
    ...
    const filteredArray = termsAndConditions.filter(obj => obj.slug === "seller-terms-and-conditions");
    useEffect(() => {
...
SellerTermsAndConditionPage.getLayout = getLayoutWithFooter;