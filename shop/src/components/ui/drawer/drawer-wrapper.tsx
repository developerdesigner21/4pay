...
const DrawerWrapper = ({ children }: { children?: React.ReactNode }) => {
  ...
  return (
    <div className="flex h-full flex-col">
      <div className="fixed top-0 z-20 flex w-full max-w-md items-center justify-between border-b border-border-200 border-opacity-75 bg-white p-5 px-5 md:px-6 w-9/12">
