...
class OrderController extends CoreController
{
    ...
    public function productAddtocart(Request $request){
        ...
        $addtocart = Addtocart::select('products.*', 'addtocart.user_id AS wuser', 'addtocart.product_id AS wproid', 'addtocart.order_quantity AS order_quantity','addtocart.variation_option_id  AS variation_option_id','addtocart.unit_price  AS unit_price', 'addtocart.subtotal AS subtotal')
            ->leftJoin('products', 'products.id', '=', 'addtocart.product_id')
            ->having('addtocart.user_id', '=', $request->get('id'))
            ->with('productVariation')
            ->get();

//        echo '<pre>'; print_r($addtocart->toArray()); exit;
        return [
            "order"=>$orderdata,
            "wishlist"=>$wishlists,
            "addtocart"=>$addtocart
