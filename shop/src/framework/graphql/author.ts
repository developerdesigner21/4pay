...
import { useNotifications_TokenMutation } from './gql/auth.graphql';
...
export function notificationtoken(){
  const [notifications_token,{data}] = useNotifications_TokenMutation()

  function TOkenNotificaiton(tdata:string){
    console.log(data);
  ...
  return {TOkenNotificaiton : TOkenNotificaiton};
}