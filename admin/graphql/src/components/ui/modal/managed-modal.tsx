...
const PushNotificationView = dynamic(() => import('@/pages/users/[userSlug]/push-notification-view'));
...
const WhatsappMarketingView = dynamic(
  () => import('@/pages/whatsappMarketing/whatsapp-messeage-popup'),
);
...
const ReminderView = dynamic(() => import('@/pages/setReminder/reminderView'));
...
function renderModal(view: MODAL_VIEWS | undefined, data: any) {
  switch (view) {
    ...
    case 'WHATSAPP_MARKETING':
      return <WhatsappMarketingView data={data} />;
    default:
      return null;
  }
}
