export const Routes = {
  ...
  shopPendingOrders: {
    ...routesFactory('/shop-pending-orders')
  },
  newShops: '/new-shops',
  ...
  shoporderinfo: '/orders/shop-order-info',
  whatsappMarketing: '/whatsappMarketing/whatsapp-marketing',
  setReminder: '/setReminder/set-reminder',

  websiteCompleteOrder: '/orders/websiteOrder/completeorders',
  websitePendingOrder: '/orders/websiteOrder/pendingorders',
  websiteCancelledOrder: '/orders/websiteOrder/cancelledorders',
