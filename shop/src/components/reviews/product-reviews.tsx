  ...
  return (
    <div>
      ...
      <div className={cn('my-5', {
        ...
        <div className="flex flex-col md:flex-row lg:flex-row 2xl:flex-row lg:space-x-5 2xl:space-x-5  py-3  sm:space-y-1 lg:flex-row lg:space-y-0 lg:!border-0 lg:py-0">
