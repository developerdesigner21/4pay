...
const layoutTypes = [
  ...
  //   label: 'Classic',
  //   value: 'classic',
  //   img: '/admin/image/layout-classic.png',
  // },
  {
    label: 'Compact',
    value: 'compact',
    img: '/admin/image/layout-compact.png',
  },
  // {
  //   label: 'Minimal',
  //   value: 'minimal',
  //   img: '/admin/image/layout-minimal.png',
  // },
  // {
  //   label: 'Modern',
  //   value: 'modern',
  //   img: '/admin/image/layout-modern.png',
  // },
  // {
  //   label: 'Standard',
  //   value: 'standard',
  //   img: '/admin/image/layout-standard.png',
  // },
];
const productCards = [
  {
    label: 'Helium',
    value: 'helium',
    img: '/admin/image/card-helium.png',
  },
  {
    label: 'Neon',
    value: 'neon',
    img: '/admin/image/card-neon.png',
  },
  {
    label: 'Argon',
    value: 'argon',
    img: '/admin/image/card-argon.png',
  },
  {
    label: 'Krypton',
    value: 'krypton',
    img: '/admin/image/card-krypton.png',
  },
  {
    label: 'Xenon',
    value: 'xenon',
    img: '/admin/image/card-xenon.png',
  },
  {
    label: 'Radon',
    value: 'radon',
    img: '/admin/image/card-radon.png',
  },
];
...
type CustomeProductInput = {
  title: string;
  category: string;
  products: InputMaybe<Array<InputMaybe<CompactProductInput>>>;
};
...
type FormValues = {
  ...
  // customeproduct: CustomeProductInput[];
};
...
export default function CreateOrUpdateGroupForm({ initialValues }: IProps) {
  ...
  const [customPro, setCustomPro] = useState<customProType>({});
  ...
  const {
    ...
    defaultValues: {
      ...
      settings: {
        ...
        pageViews: initialValues?.settings?.pageViews
          ? initialValues.settings.pageViews
          : concatenatedString,
        handpickedProducts: {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)}>
      ...
      <div>
        <div className="my-5 flex  border-b border-dashed border-border-base pb-8 sm:my-8">
          <Description
            title={'Page View'}
            // details={'Upload Sliders'}
            className="w-full px-0 pb-5 sm:w-4/12 sm:py-8 sm:pe-4 md:w-1/3 md:pe-5"
