...
class AuthMutator
{
    ...
    public function customeotpverification($rootValue, array $args, GraphQLContext $context)
    {
        return Shop::call('Marvel\Http\Controllers\UserController@customeotpverification', $args);
    }
    public function rcustomeotpverification($rootValue, array $args, GraphQLContext $context)
    {
        return Shop::call('Marvel\Http\Controllers\UserController@rcustomeotpverification', $args);
    }
    public function notificationstoken($rootValue, array $args, GraphQLContext $context)
    {
