...
export default function CreateOrUpdateProductForm({
  ...
  const onSubmit = async (values: ProductFormValues) => {
    ...
    values?.variation_options?.map((item:any) => {
      item.image = item?.image?.map((imgitem:any) => {
        return {id:imgitem.id,original:imgitem.original,thumbnail:imgitem.thumbnail,}
      })
      return item;
    })
            ...
            <Card className="w-full sm:w-8/12 md:w-2/3">
              ...
              <div className="relative">
                ...
                <TextEditor
                  ...
                  variant="outline"
                  className="mb-5"
                  getnewvaluse={getValues('description')}
