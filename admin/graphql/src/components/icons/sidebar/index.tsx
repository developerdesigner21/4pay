...
export { DeliveryPersonIcon } from '@/components/custome/delivery-person-icon';
export { WebsiteIcon } from '@/components/custome/website-icon';
export { WhatsappIcon } from '@/components/custome/whatsapp';